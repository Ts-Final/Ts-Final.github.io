...
import {ResearchInfClass} from "../../../core/research/class.ts";

defineProps<{research:ResearchInfClass}>()
  ...
  <div class="rch-top blue-border" v-if="research?.unlocked && !research?.finished.value">
    <div class="show">
      ...
      <div class="second-row">
        <p class="level">Lv. {{research.level}}</p>
